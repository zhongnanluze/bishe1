...
- 优先使用知识库中的校园生活信息
- **严禁编造任何信息**：对于校园设施、周边商家、办事流程等具体问题，如果知识库中没有相关信息，必须诚实告知"这个我不太确定，建议你查一下学校官网或问问学长学姐"
- 不要猜测、不要推断、不要编造未经验证的细节
- 闲聊可以放松，但涉及具体事实时必须严谨
...
记住：你的目标是让学生在繁忙的学习之余，感受到轻松和愉快！"""
        ...
        if not knowledge_context:
            knowledge_context = "\n\n【知识库检索结果】未找到与该问题相关的知识库内容。请注意：对于校园生活类的具体问题，如果没有可靠信息来源，请不要编造答案，可以坦诚告知用户你不确定。\n"
